...
export default function RootLayout({
  ...
  useEffect(() => {
    if (add.includes("calender")) {
      setSelected("calender");
    } else if (add.includes("test")) {
      setSelected("test");
    } else if (add.includes("messages")) {
      setSelected("messages");
    } else if (add.includes("setting")) {
      setSelected("setting");
    } else if (add.includes("reportcard")) {
      setSelected("reportcard");
    } else {
  ...
  async function handler(event: any) {
    ...
    } else if (event == "calender") {
      await router.push("/student/calender");
    } else if (event == "test") {
      await router.push("/student/test");
    } else if (event == "reportcard") {
      await router.push("/student/reportcard");
    } else if (event == "setting") {
      await router.push("/student/setting");
    } else if (event == "messages") {
      await router.push("/student/messages");
    } else {
      await router.push("/student/");
    }
  }
                ...
                <nav className="m-0 ">
                  <div>
                    <p
                      ...
                      className={`w-full font-thin cursor-pointer uppercase ${
                        select === "dashboard"
                          ? " text-blue-500"
                          : "text-gray-500"
                      } text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500 dark:from-gray-700 dark:to-gray-800`}
                    >
                    ...
                    <p
                      ...
                      className={`w-full cursor-pointer font-thin uppercase ${
                        select === "test" ? " text-blue-500" : "text-gray-500"
                      } text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500 dark:from-gray-700 dark:to-gray-800`}
                    >
                      <span className="text-left">
                        <svg
                      ...
                      <span className="mx-4 text-sm font-normal">My Test</span>
                    </p>
                    <p
                      onClick={() => {
                        handler("calender");
