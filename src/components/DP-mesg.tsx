...
export default function () {
  return (
    <>
      <div className="flex items-center pl-10 min-h-screen from-[#98b8e1]  to-[#3c74bb] bg-gradient-to-b">
        <div className=" mx-auto mr-0 from-[#98b8e1]  to-[#6091d0] bg-gradient-to-b relative w-full group max-w-md  mt-6 mb-6 break-words bg-white border shadow-2xl  md:max-w-sm rounded-xl">
          <div className="pb-6">
              ...
              <div className="flex justify-center w-full">
                <div className="relative">
                  <img
                    ...
                    className=" border-white  rounded-full align-middle border-4 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]"
                  />
                </div>
              </div>
            </div>
            <div className=" mt-20 text-center">
              ...
              <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                <div className=" font-bold tracking-wide text-gray-600  font-mono text-xl">
                  Director
                </div>
              </div>
            ...
            <div className="pt-6 mx-6 mt-6 text-center border-t border-gray-200 ">
              <div className="flex flex-wrap justify-center">
                <div className="w-full px-6">
                  <p className="mb-4 font-light font-mono leading-relaxed text-[#16233b] ">
        ...
        <div className=" mx-auto from-[#98b8e1]  to-[#6091d0] bg-gradient-to-b relative w-full group max-w-md  mt-6 mb-6 break-words bg-white border shadow-2xl  md:max-w-sm rounded-xl">
          <div className="pb-6">
            <div className="flex flex-wrap ">
              <div className="flex justify-center w-full">
                <div className="relative">
